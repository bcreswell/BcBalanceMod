...
public abstract class AbstractDungeon
{
    ...
    public AbstractDungeon(String name, String levelId, AbstractPlayer p, ArrayList<String> newSpecialOneTimeEventList)
    {
        ...
        this.initializeBoss();
        this.setBoss((String) bossList.get(0));
    ...
    public void populatePathTaken(SaveFile saveFile)
    {
        ...
        for (int i = 0; i < pathX.size(); ++i)
        {
            ...
            {
                MapRoomNode node2 = (MapRoomNode) ((ArrayList) map.get((Integer) pathY.get(i))).get((Integer) pathX.get(i));
                Iterator var5 = node2.getEdges().iterator();
                
                while (var5.hasNext())
                {
                    MapEdge e = (MapEdge) var5.next();
                    if (e != null)
                    {
                        e.markAsTaken();
                    }
            ...
            if ((Integer) pathY.get(i) < 15)
            {
                ((MapRoomNode) ((ArrayList) map.get((Integer) pathY.get(i))).get((Integer) pathX.get(i))).taken = true;
                if (node != null)
                {
                    MapEdge connectedEdge = node.getEdgeConnectedTo((MapRoomNode) ((ArrayList) map.get((Integer) pathY.get(i))).get((Integer) pathX.get(i)));
                ...
                node = (MapRoomNode) ((ArrayList) map.get((Integer) pathY.get(i))).get((Integer) pathX.get(i));
            }
        }
    ...
    protected static void generateMap()
    {
        ...
        while (var7.hasNext())
        {
            ArrayList<MapRoomNode> a = (ArrayList) var7.next();
            Iterator var9 = a.iterator();
            
            while (var9.hasNext())
            {
                MapRoomNode n = (MapRoomNode) var9.next();
        ...
        {
            RoomTypeAssigner.assignRowAsRoomType((ArrayList) map.get(8), MonsterRoomElite.class);
        }
        else
        {
    ...
    private boolean passesDonutCheck(ArrayList<ArrayList<MapRoomNode>> map)
    {
        ...
        ArrayList<MapRoomNode> secondToLastRow = (ArrayList) map.get(map.size() - 2);
        Iterator var7 = secondToLastRow.iterator();
        
        while (var7.hasNext())
        {
            MapRoomNode n = (MapRoomNode) var7.next();
        ...
        else
        {
            ...
            roomCount = 0;
            Iterator var14 = map.iterator();
            
            while (var14.hasNext())
            {
                ArrayList<MapRoomNode> rows = (ArrayList) var14.next();
                Iterator var16 = rows.iterator();
                
                while (var16.hasNext())
                {
                    MapRoomNode n = (MapRoomNode) var16.next();
                    if (n.room != null)
                    {
                        ++roomCount;
                    }
    ...
    public static void setCurrMapNode(MapRoomNode currMapNode)
    {
        ...
        if (AbstractDungeon.currMapNode.room == null)
        {
            ...
            for (int i = 0; i < 5; ++i)
            {
                ...
                {
                    AbstractDungeon.currMapNode = (MapRoomNode) ((ArrayList) map.get(currMapNode.y)).get(i);
                    AbstractDungeon.currMapNode.room = ((MapRoomNode) ((ArrayList) map.get(currMapNode.y)).get(i)).room;
    ...
    public static CardGroup getEachRare()
    {
        ...
        Iterator var1 = rareCardPool.group.iterator();
    ...
    {
        ArrayList<AbstractCard> list = new ArrayList();
        Iterator var3 = srcColorlessCardPool.group.iterator();
    ...
    public void populateMonsterList(ArrayList<MonsterInfo> monsters, int numMonsters, boolean elites)
    {
        ...
        if (elites)
        {
            for (i = 0; i < numMonsters; ++i)
            {
                ...
                {
                    toAdd = MonsterInfo.roll(monsters, monsterRng.random());
    ...
    private void addColorlessCards()
    {
        ...
        while (var2.hasNext())
        {
            Entry<String, AbstractCard> c = (Entry) var2.next();
    ...
    private void addCurseCards()
    {
        ...
        while (var2.hasNext())
        {
            Entry<String, AbstractCard> c = (Entry) var2.next();
            AbstractCard card = (AbstractCard) c.getValue();
            if (card.type == AbstractCard.CardType.CURSE && !Objects.equals(card.cardID, "Necronomicurse") && !Objects.equals(card.cardID, "AscendersBane") && !Objects.equals(card.cardID, "CurseOfTheBell") && !Objects.equals(card.cardID, "Pride"))
            {
...
//        }
        ...
        while (true)
        {
            while (var11.hasNext())
            {
                ...
                else
                {
                    ...
                    while (var12.hasNext())
                    {
                        AbstractRelic r1 = (AbstractRelic) var12.next();
                        r1.onPreviewObtainCard(card);
                    }
                }
            }
    ...
    {
        return currMapNode.room.monsters.getRandomMonster((AbstractMonster) null, true, cardRandomRng);
    }
        ...
        if (currMapNode.room instanceof MonsterRoom)
        {
            if (!CardCrawlGame.loadingSave)
            {
                ...
                else
                {
                    ...
                    metrics.setValues(false, false, (MonsterGroup) null, Metrics.MetricRequestType.NONE);
    ...
    {
        this.nextRoomTransition((SaveFile) null);
    }
    ...
    public void nextRoomTransition(SaveFile saveFile)
    {
        ...
        if (getCurrRoom() instanceof MonsterRoomElite)
        {
            if (!eliteMonsterList.isEmpty())
            {
                logger.info("Removing elite: " + (String) eliteMonsterList.get(0) + " from monster list.");
        ...
        else if (getCurrRoom() instanceof MonsterRoom)
        {
            if (!monsterList.isEmpty())
            {
                logger.info("Removing monster: " + (String) monsterList.get(0) + " from monster list.");
        ...
        if (!CardCrawlGame.loadingSave)
        {
            ...
            ++floorNum;
            if (!(Boolean) TipTracker.tips.get("INTENT_TIP") && floorNum == 6)
            {
        ...
        if (isLoadingCompletedEvent)
        {
            ...
            eventKey = (String) ((HashMap) saveFile.metric_event_choices.get(saveFile.metric_event_choices.size() - 1)).get("event_name");
    ...
    public MonsterGroup getMonsterForRoomCreation()
    {
        ...
        logger.info("MONSTER: " + (String) monsterList.get(0));
    ...
    public MonsterGroup getEliteMonsterForRoomCreation()
    {
        ...
        logger.info("ELITE: " + (String) eliteMonsterList.get(0));
    ...
    public static AbstractEvent getShrine(Random rng)
    {
        ...
        Iterator var2 = specialOneTimeEventList.iterator();
    ...
    public void render(SpriteBatch sb)
    {
        ...
        Iterator var2 = effectList.iterator();
        ...
        Iterator var6 = effectList.iterator();
        
        AbstractGameEffect e;
        while (var6.hasNext())
        {
            e = (AbstractGameEffect) var6.next();
            if (!e.renderBehind)
            {
                e.render(sb);
            }
