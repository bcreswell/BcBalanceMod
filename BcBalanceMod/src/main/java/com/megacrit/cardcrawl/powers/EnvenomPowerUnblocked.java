...
public class EnvenomPowerUnblocked extends AbstractPower
{
    ...
    public EnvenomPowerUnblocked(AbstractCreature owner, int newAmount)
    {
        this.name = NAME;
        this.ID = "Envenom";
        this.owner = owner;
    ...
    {
        if (((damageAmount > 0) || isUpgraded) && target != this.owner && info.type == DamageType.NORMAL)
        {
            this.flash();
