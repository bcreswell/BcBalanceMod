...
public class BcNeowEvent extends AbstractEvent
{
    ...
    private ArrayList<BcNeowReward> rewards;
    BcNeowReward selectedReward;
    ...
    public BcNeowEvent(boolean isDone)
    {
        this.screenNum = 2;
    ...
    public void update()
    {
        ...
        while (var4.hasNext())
        {
            BcNeowReward r = (BcNeowReward) var4.next();
            r.update();
        }
        ...
        boolean rewardComplete = selectedReward != null ? selectedReward.rewardState == BcNeowReward.BcNeowRewardState.RewardComplete : false;
        if (waitingToSave && !AbstractDungeon.isScreenUp && AbstractDungeon.topLevelEffects.isEmpty() && AbstractDungeon.player.relicsDoneAnimating() && rewardComplete)
        {
    ...
    protected void buttonEffect(int buttonPressed)
    {
        switch (this.screenNum)
        {
            ...
            case 1:
                this.dismissBubble();
                logger.info((Object) this.bossCount);
                this.blessing();
                break;
            case 2:
                if (buttonPressed == 0)
            ...
            case 3:
                ...
                selectedReward = this.rewards.get(buttonPressed);
                selectedReward.activate();
                if ((selectedReward.rewardCurse == null) && (selectedReward.relicToLose == null))
                {
                    this.talk(TEXT[8]);
                }
                else
    ...
    private void blessing()
    {
        ...
        this.dismissBubble();
        this.talk(TEXT[7]);
        this.rewards.add(new BcNeowReward(0));
    ...
    static
    {
        ...
        DIALOG_Y = AbstractDungeon.floorY + 200.0F * Settings.yScale;
    }
}
