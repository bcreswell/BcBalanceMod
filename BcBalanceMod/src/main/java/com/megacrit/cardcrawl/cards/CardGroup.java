...
public class CardGroup
{
    ...
    public int fullSetCheck()
    {
        ...
        while (var7.hasNext())
        {
            Entry<String, Integer> card = (Entry) var7.next();
...
label113:
            switch (this.group.size())
            {
                ...
                case 3:
                    ...
                    var10000 = (AbstractCard) this.group.get(0);
                ...
                case 4:
                    ...
                    var10000 = (AbstractCard) this.group.get(1);
                ...
                case 5:
                    ...
                    var10000 = (AbstractCard) this.group.get(2);
                    var10000.target_y -= 10.0F * Settings.scale;
                    var10000 = (AbstractCard) this.group.get(4);
                    var10000.target_y += 25.0F * Settings.scale;
                    break;
                case 6:
                    ...
                    var10000 = (AbstractCard) this.group.get(0);
                    var10000.target_y += 10.0F * Settings.scale;
                    var10000 = (AbstractCard) this.group.get(5);
                    var10000.target_y += 10.0F * Settings.scale;
                    break;
                case 7:
                    ...
                    var10000 = (AbstractCard) this.group.get(3);
                    var10000.target_y -= 6.0F * Settings.scale;
                    var10000 = (AbstractCard) this.group.get(5);
                    var10000.target_y += 18.0F * Settings.scale;
                    var10000 = (AbstractCard) this.group.get(6);
                    var10000.target_y += 25.0F * Settings.scale;
                    break;
                case 8:
                ...
                case 9:
                    ...
                    var10000 = (AbstractCard) this.group.get(6);
                    var10000.target_y += 18.0F * Settings.scale;
                    var10000 = (AbstractCard) this.group.get(7);
                    var10000.target_y += 22.0F * Settings.scale;
                    var14 = this.group.iterator();
                ...
                case 10:
                    ...
                    var10000 = (AbstractCard) this.group.get(7);
                    var10000.target_y += 17.0F * Settings.scale;
                    var10000 = (AbstractCard) this.group.get(8);
                    var10000.target_y += 20.0F * Settings.scale;
                    var14 = this.group.iterator();
    ...
    public void glowCheck()
    {
        ...
        {
            c = (AbstractCard) var1.next();
            if (c.canUse(AbstractDungeon.player, (AbstractMonster) null) && AbstractDungeon.screen != AbstractDungeon.CurrentScreen.HAND_SELECT)
            {
                c.beginGlowing();
            }
            else
    ...
    public void hoverCardPush(AbstractCard c)
    {
        if (this.group.size() > 1)
        {
            ...
            {
                var10000 = (AbstractCard) this.group.get(currentSlot);
    ...
    public CardGroup getPurgeableCurses()
    {
        CardGroup retVal = new CardGroup(CardGroup.CardGroupType.UNSPECIFIED);
        ...
        for (AbstractCard card : group)
        {
            if (card.type == AbstractCard.CardType.CURSE)
            {
                ...
                else if (card instanceof BcCurseCardBase)
                {
                    BcCurseCardBase bcCurse = (BcCurseCardBase) card;
                    if (!bcCurse.isPurgeable())
                    {
                        continue;
                    }
                }
    ...
    public CardGroup getGroupedByColor()
    {
        ...
        AbstractCard.CardColor[] var2 = AbstractCard.CardColor.values();
        int var3 = var2.length;
        
        for (int var4 = 0; var4 < var3; ++var4)
        {
            AbstractCard.CardColor var10000 = var2[var4];
        ...
        CardGroup retVal = new CardGroup(CardGroup.CardGroupType.UNSPECIFIED);
        Iterator var9 = colorGroups.iterator();
        
        while (var9.hasNext())
        {
            CardGroup group = (CardGroup) var9.next();
