...
public class FontHelper
{
    ...
    public static void renderTipLeft(SpriteBatch sb, String msg)
    {
        ...
        sb.draw(ImageMaster.WHITE_SQUARE_IMG, (float) InputHelper.mX - layout.width - 16.0F - 12.5F, (float) InputHelper.mY - layout.height, layout.width + 16.0F, layout.height + 16.0F);
        renderFont(sb, cardDescFont_N, msg, (float) InputHelper.mX - layout.width - 8.0F - 12.0F, (float) InputHelper.mY + 8.0F, Color.WHITE);
    }
    
    public static void renderFont(SpriteBatch sb, BitmapFont font, String msg, float x, float y, Color c)
    {
        font.setColor(c);
        font.draw(sb, (CharSequence) msg, x, y);
    }
    ...
    public static void renderFontRightToLeft(SpriteBatch sb, BitmapFont font, String msg, float x, float y, Color c)
    {
        ...
        font.setColor(c);
        font.draw(sb, (CharSequence) msg, x - layout.width, y);
    }
    ...
    {
        renderSmartText(sb, font, msg, x, y, 3.4028235E38F, font.getLineHeight(), baseColor);
    }
                ...
                for (int var10 = 0; var10 < var9; ++var10)
                {
                    ...
                    else
                    {
                        ...
                        if (orb == null)
                        {
                            ...
                            {
                                curHeight -= lineSpacing;
                                font.draw(sb, (CharSequence) word, x, y + curHeight);
                                curWidth = layout.width + spaceWidth;
                            }
                            else
                            {
                                font.draw(sb, (CharSequence) word, x + curWidth, y + curHeight);
                                curWidth += layout.width + spaceWidth;
                            }
                        }
                        else
    ...
    private static Color identifyColor(String word)
    {
        if (word.length() > 0 && word.charAt(0) == '#')
        {
            switch (word.charAt(1))
            {
                ...
                case 'l': //l is for black... because b was taken
    ...
    public static void renderDeckViewTip(SpriteBatch sb, String msg, float y, Color color)
    {
        ...
        sb.draw(ImageMaster.WHITE_SQUARE_IMG, (float) Settings.WIDTH / 2.0F - layout.width / 2.0F - 12.0F * Settings.scale, y - 24.0F * Settings.scale, layout.width + 24.0F * Settings.scale, 48.0F * Settings.scale);
            ...
            if (word.length() != 0)
            {
                ...
                else if (word.charAt(0) == '[')
                {
                    ...
                    if (orb != null)
                    {
                        ...
                        if (!(CARD_ENERGY_IMG_WIDTH > widthMax * 2.0F))
                        {
                            ...
                            {
                                sb.draw(orb, x - (float) orb.packedWidth / 2.0F + 14.0F * Settings.scale, y - (float) currentLine * lineSpacing - (float) orb.packedHeight / 2.0F - 38.0F * Settings.scale, (float) orb.packedWidth / 2.0F, (float) orb.packedHeight / 2.0F, (float) orb.packedWidth, (float) orb.packedHeight, Settings.scale, Settings.scale, 0.0F);
                            }
                            else
                            {
                                sb.draw(orb, x + curWidth - (float) orb.packedWidth / 2.0F + 14.0F * Settings.scale, y - (float) currentLine * lineSpacing - (float) orb.packedHeight / 2.0F - 8.0F * Settings.scale, (float) orb.packedWidth / 2.0F, (float) orb.packedHeight / 2.0F, (float) orb.packedWidth, (float) orb.packedHeight, Settings.scale, Settings.scale, 0.0F);
                            }
                        }
                ...
                else if (word.charAt(0) == '#')
                {
                    ...
                    if (curWidth > widthMax)
                    {
                        curWidth = 0.0F;
                        ++currentLine;
                        font.draw(sb, (CharSequence) word, x + curWidth, y - lineSpacing * (float) currentLine);
                        curWidth = layout.width;
                    }
                    else
                    {
                        font.draw(sb, (CharSequence) word, x + curWidth - layout.width, y - lineSpacing * (float) currentLine);
                    }
                }
                else
                {
                    ...
                    for (int i = 0; i < word.length(); ++i)
                    {
                        ...
                        font.draw(sb, (CharSequence) j, x + curWidth - layout.width, y - lineSpacing * (float) currentLine);
                    }
                }
            }
        }
