...
public class TooFastAction extends AbstractGameAction
{
    private AbstractPlayer player;
    private int numCardsToPick;
    
    public TooFastAction(int numCardsToDraw)
    {
    ...
    public void update()
    {
        if (duration == startDuration)
        {
            ...
            {
                if ((drawPileCard.type == AbstractCard.CardType.ATTACK) && (drawPileCard.costForTurn == 0))
                {
