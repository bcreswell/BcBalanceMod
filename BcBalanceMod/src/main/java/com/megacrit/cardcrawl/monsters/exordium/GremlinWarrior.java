...
public class GremlinWarrior extends AbstractMonster
{
    ...
    {
        super(NAME, "GremlinWarrior", 24, -4.0F, 12.0F, 130.0F, 194.0F, (String) null, x, y);
    ...
    public void usePreBattleAction()
    {
        ...
        {
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(this, this, new AngryPower(this, 3)));
        }
        else
        {
    ...
    public void takeTurn()
    {
        switch (this.nextMove)
        {
            case 1:
                ...
                {
                    AbstractDungeon.actionManager.addToBottom(new SetMoveAction(this, (byte) 1, AbstractMonster.Intent.ATTACK, ((DamageInfo) this.damage.get(0)).base));
                }
                break;
            case 99:
                this.playSfx();
