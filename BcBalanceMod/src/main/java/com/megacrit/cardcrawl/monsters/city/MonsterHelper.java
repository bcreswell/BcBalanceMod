...
public class MonsterHelper {
                ...
                switch(var2) {
                    ...
                    default:
                        ...
                        switch(var2) {
                            ...
                            case 1:
                            case 2:
                                return new MonsterGroup(new AbstractMonster[]{new SnakeDagger(Reptomancer.POSX[0], Reptomancer.POSY[0]), new SnakeDagger(Reptomancer.POSX[1], Reptomancer.POSY[1]), new Reptomancer()});
                            case 3:
    ...
    public static void uploadEnemyData() {
        ...
        while(var2.hasNext()) {
            EnemyData d = (EnemyData)var2.next();
