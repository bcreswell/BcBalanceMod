...
public class AcidSlime_M extends AbstractMonster {
    ...
    public AcidSlime_M(float x, float y, int poisonAmount, int newHealth) {
        super(NAME, "AcidSlime_M", newHealth, 0.0F, 0.0F, 170.0F, 130.0F, (String)null, x, y, true);
            ...
            if (num < 40) {
                if (this.lastTwoMoves((byte)1)) {
                    if (AbstractDungeon.aiRng.randomBoolean()) {
                        this.setMove((byte)2, AbstractMonster.Intent.ATTACK, ((DamageInfo)this.damage.get(1)).base);
                    } else {
                        this.setMove(WEAK_NAME, (byte)4, AbstractMonster.Intent.DEBUFF);
                    }
                } else {
                    this.setMove(WOUND_NAME, (byte)1, AbstractMonster.Intent.ATTACK_DEBUFF, ((DamageInfo)this.damage.get(0)).base);
                }
            } else if (num < 80) {
