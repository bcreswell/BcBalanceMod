...
public class HandCardSelectScreen
{
    ...
    {
        this.selectedCards = new CardGroup(CardGroup.CardGroupType.UNSPECIFIED);
    ...
    private void updateSelectedCards()
    {
        ...
        Iterator i = this.selectedCards.group.iterator();
    ...
    private void updateMessage()
    {
        ...
        {
            if (this.anyNumber || upTo)
            {
                this.message = TEXT[2] + "up to " +  numLeft + TEXT[3] + this.selectionReason;
            }
            else
            {
