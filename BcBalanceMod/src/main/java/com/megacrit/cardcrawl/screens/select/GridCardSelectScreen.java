...
public class GridCardSelectScreen implements ScrollBarListener {
    ...
    public void update() {
        ...
        if (!PeekButton.isPeeking) {
            ...
            } else if ((this.anyNumber || this.forClarity) && this.confirmButton.hb.clicked) {
                this.confirmButton.hb.clicked = false;
                AbstractDungeon.closeCurrentScreen();
            } else {
    ...
    public void open(CardGroup group, int numCards, boolean anyNumber, String msg) {
        this.open(group, numCards, msg, false, false, false, false);
        ...
        {
            //bc: hack to make it equivalent to previous logic
            canCancel = true;
            AbstractDungeon.overlayMenu.cancelButton.show(TEXT[1]);
        }
    }
    
    public void open(CardGroup group, int numCards, boolean anyNumber, String msg, boolean canCancel) {
        this.open(group, numCards, msg, false, false, canCancel, false);
        this.anyNumber = anyNumber;
        this.forClarity = !anyNumber;
        this.confirmButton.hideInstantly();
        this.confirmButton.show();
    ...
    public void open(CardGroup group, int numCards, String tipMsg, boolean forUpgrade) {
        this.open(group, numCards, tipMsg, forUpgrade, false, false, false);
    }
