...
public class MindBloom extends AbstractImageEvent {
    ...
    private MindBloom.CurScreen screen;
    
    public MindBloom() {
        super(NAME, DIALOG_1, "images/events/mindBloom.jpg");
        this.screen = MindBloom.CurScreen.INTRO;
                ...
                switch(buttonPressed) {
                    ...
                    case 2:
                        if (AbstractDungeon.floorNum % 50 <= 40) {
                            ...
                            AbstractDungeon.effectList.add(new ShowCardAndObtainEffect(new Normality(), (float)Settings.WIDTH * 0.7F, (float)Settings.HEIGHT / 2.0F));
                            AbstractDungeon.effectList.add(new ShowCardAndObtainEffect(new Normality(), (float)Settings.WIDTH * 0.45F, (float)Settings.HEIGHT / 2.0F));
                            AbstractDungeon.effectList.add(new ShowCardAndObtainEffect(new Normality(), (float)Settings.WIDTH * 0.2F, (float)Settings.HEIGHT / 2.0F));
                            this.imageEventText.updateDialogOption(0, OPTIONS[4]);
                        } else {
                            this.imageEventText.updateBodyText(DIALOG_2);
                            this.screen = MindBloom.CurScreen.LEAVE;
