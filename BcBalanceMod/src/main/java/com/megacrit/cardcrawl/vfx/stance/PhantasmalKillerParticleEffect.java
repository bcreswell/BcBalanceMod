...
public class PhantasmalKillerParticleEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vY;
    ...
    public PhantasmalKillerParticleEffect() {
        ...
        this.color = new Color(MathUtils.random(0.2F, .5F), MathUtils.random(0.5F, 1.0F), MathUtils.random(0.0F, 0.2F), 0.0F);
