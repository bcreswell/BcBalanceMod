...
public class NinjaSmokeEffect extends AbstractGameEffect
{
    private float x;
    private float y;
    private float vY;
    ...
    public NinjaSmokeEffect(float x, float y)
    {
        this.color = new Color(0.7F, 0.7F, 0.7F, 0.6F);
        ...
        this.vY = MathUtils.random(.5F * Settings.scale, 3.0F * Settings.scale);
        this.vX = MathUtils.random(-4.0F * Settings.scale, 7.0F * Settings.scale);
    }
